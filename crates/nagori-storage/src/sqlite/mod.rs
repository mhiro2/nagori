...
mod tests {
    use nagori_core::{
        ContentKind, EntryFactory, EntryId, EntryRepository, RankReason, RecentOrder,
        RepresentationDataRef, RepresentationRole, SearchFilters, SearchMode, SearchQuery,
        Sensitivity, ThumbnailRecord,
    };
