...
export const zhHans: Messages = {
  ...
  settings: {
    ...
    ai: {
      ...
      semanticIndexStateUnavailable: '嵌入模型不可用',
      semanticIndexStateUnsupported: '此设备不支持',
      semanticIndexStateDisabled: '已禁用',
      status: '可用性',
      statusAvailable: '可用',
    ...
    hotkeys: {
      ...
      paletteHelp: '在面板内使用的快捷键。未自定义的操作使用其默认按键。',
      secondaryHeading: '附加全局快捷键',
      secondaryHelp:
        '无需打开面板即可触发的可选全局快捷键。仅设置需要的操作；未设置的操作处于禁用状态。',
      placeholder: '设置快捷键',
      ...
      notSet: '未设置',
      reset: '重置',
      fieldAriaLabel: '{action}快捷键',
      restoreDefault: '将 {action} 恢复为默认',
      removeShortcut: '解除 {action} 的快捷键',
      disableShortcut: '禁用 {action}',
      paletteActions: {
        pin: '切换固定',
        delete: '删除项目',
