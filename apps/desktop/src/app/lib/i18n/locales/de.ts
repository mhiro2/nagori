...
export const de: Messages = {
  ...
  settings: {
    ...
    hotkeys: {
      ...
      paletteHelp:
        'Tastenkürzel, die innerhalb der Palette verwendet werden. Nicht angepasste Aktionen nutzen ihre Standardtasten.',
      secondaryHeading: 'Zusätzliche globale Tastenkürzel',
      secondaryHelp:
        'Optionale globale Tastenkürzel, die ohne Öffnen der Palette funktionieren. Lege nur die benötigten Aktionen fest; nicht festgelegte Aktionen sind deaktiviert.',
      placeholder: 'Tastenkürzel festlegen',
      recordingHint: 'Tastenkürzel drücken…',
      recordingCancelHint: 'Esc zum Abbrechen',
      clearAriaLabel: 'Tastenkürzel löschen',
      defaultMarker: 'Standard',
      disabledMarker: 'Deaktiviert',
      notSet: 'Nicht festgelegt',
      reset: 'Zurücksetzen',
      fieldAriaLabel: 'Tastenkürzel für {action}',
      restoreDefault: 'Standard für {action} wiederherstellen',
      removeShortcut: 'Tastenkürzel für {action} entfernen',
      disableShortcut: '{action} deaktivieren',
      paletteActions: {
