...
export const ko: Messages = {
  ...
  status: {
    ...
    pasteDiagnostics: {
      ...
      hint: {
        ...
        clipboardChanged:
          '자동 붙여넣기 취소: 복사 후 클립보드가 바뀌어 아무것도 붙여넣지 않았습니다. 다시 복사하세요.',
  ...
  settings: {
    ...
    hotkeys: {
      ...
      paletteHelp:
        '팔레트 안에서 사용하는 단축키입니다. 변경하지 않은 항목은 기본 키를 사용합니다.',
      secondaryHeading: '보조 전역 단축키',
      secondaryHelp:
        '팔레트를 열지 않고도 동작하는 선택적 전역 단축키입니다. 필요한 항목만 설정하세요. 설정하지 않은 항목은 비활성화됩니다.',
      placeholder: '단축키 설정',
      recordingHint: '단축키를 누르세요…',
      recordingCancelHint: 'Esc로 취소',
      clearAriaLabel: '단축키 지우기',
      defaultMarker: '기본값',
      disabledMarker: '비활성화됨',
      notSet: '설정 안 됨',
      reset: '재설정',
      fieldAriaLabel: '{action} 단축키',
      restoreDefault: '{action} 기본값으로 되돌리기',
      removeShortcut: '{action} 단축키 해제',
      disableShortcut: '{action} 비활성화',
      paletteActions: {
        pin: '고정 전환',
        delete: '항목 삭제',
