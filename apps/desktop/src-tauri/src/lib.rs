...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::entry_commands::add_entry,
            commands::entry_commands::delete_entry,
            commands::entry_commands::delete_entries,
            commands::entry_commands::purge_deleted_entries,
            commands::paste_commands::copy_entries_combined,
            commands::entry_commands::clear_history,
            commands::paste_commands::repaste_last,
            commands::entry_commands::pin_entry,
            commands::ai_commands::run_quick_action,
            commands::ai_commands::start_ai_action,
            commands::ai_commands::cancel_ai_action,
            commands::ai_commands::get_ai_availability,
            commands::ai_commands::get_semantic_index_status,
            commands::ai_commands::rebuild_semantic_index,
            ...
            commands::settings_commands::request_accessibility,
            commands::settings_commands::open_url_external,
            commands::window_commands::toggle_palette,
            commands::window_commands::hide_palette,
            commands::window_commands::open_settings,
            commands::window_commands::close_settings,
